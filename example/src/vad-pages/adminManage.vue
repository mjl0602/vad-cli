...
import { ElTable, ElTableColumn, ElPagination, ElButton, ElButtonGroup, ElDialog } from 'element-plus'
import { ElForm, ElFormItem, ElInput, ElCheckboxGroup, ElCheckbox, ElSwitch, ElDatePicker, ElTimePicker, ElSelect } from 'element-plus'
